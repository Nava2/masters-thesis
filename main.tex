...
\BeforeBeginEnvironment{displayquote}{\begin{singlespace}}
\AfterEndEnvironment{displayquote}{\end{singlespace}}
...
I would like to acknowledge: Ramesh, Brad, Thomas, Kyle.
}
...
& 2015 - 2016\\
\end{tabular}
\todo[inline, backgroundcolor=green!40]{fix vertical spacing for ``sections''}
\todo[inline, backgroundcolor=green!40]{align inner table for years}
\end{table}
\end{singlespace}
