...
An assignment statement, e.g. \luainline{proc.R = operand.A} is identical to scheduling the following actions: 
\begin{enumerate}
...
proc:X = proc:A + proc:B -- 'result' of this is a `BusValue' of value of proc:X
\end{minted}
