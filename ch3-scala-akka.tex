\chapter{procsim.scala: Scala-based event-driven processor simulation for the web}
\label{ch:scala-akka}
...
\begin{figure}[!h]
    \begin{minipage}{0.5\textwidth}
        \centering
        \begin{minted}[breaklines, breakafter=.]{scala}
        ...
        \end{minted}
        \captionof{listing}{Normal definition of Instruction.}
        \label{lst:procsim-scala:concrete-instruction-def}
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \begin{minted}[breaklines, linenos=false, breakafter=.]{scala}
        ...
        \end{minted}
        \captionof{listing}{Reified definition of Instruction.}
