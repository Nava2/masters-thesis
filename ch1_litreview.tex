...
\begin{enumerate}[ref={proposition~\arabic*}]
    ...
    \item Improve/replace software within laboratory
        \label{prop:replace-software}
\end{enumerate}

\begin{table}[!h]
    \centering
    \begin{tabular}{lc|r|r|r|r}
